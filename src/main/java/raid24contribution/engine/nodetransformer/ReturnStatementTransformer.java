...
/**
 * we handle the childnode and get the top expression from the stack, this is
 * the returned value if their wasn't an expression nothing is returned then we
 * create a new returnExpression and add it to the stack
 * 
 * @author Florian
 * 
 */
