...
/**
 * the Block-tag contains the body of a function we save all Childnodes and put
 * them into a list so we can handle them later but if we ar already inside of a
 * functionblock , we handle this chidlnodes
 * 
 * @author Florian
 * 
 */
